...
def _orders(now: datetime) -> list[Order]:
    ...
    return [
        Order(id="ORD-1001", customer_id="cust_001", status="delivered", total=Decimal("49.99"),
              items=[{"sku": "MUG-01", "name": "Ceramic mug", "qty": 2}],
              placed_at=d(9), delivered_at=d(5), carrier="Royal Mail", tracking_number="RM123GB"),
        Order(id="ORD-1002", customer_id="cust_001", status="delivered", total=Decimal("249.00"),
              items=[{"sku": "HEAD-02", "name": "Noise-cancelling headphones", "qty": 1}],
              placed_at=d(14), delivered_at=d(10), carrier="DPD", tracking_number="DPD998877"),
        Order(id="ORD-1003", customer_id="cust_001", status="shipped", total=Decimal("19.50"),
              items=[{"sku": "BOOK-07", "name": "Paperback novel", "qty": 1}],
              placed_at=d(2), delivered_at=None, carrier="Royal Mail", tracking_number="RM555GB"),
        Order(id="ORD-1004", customer_id="cust_001", status="delivered", total=Decimal("75.00"),
              items=[{"sku": "LAMP-03", "name": "Desk lamp", "qty": 1}],
              placed_at=d(50), delivered_at=d(45), carrier="DPD", tracking_number="DPD112233"),
        Order(id="ORD-2001", customer_id="cust_002", status="delivered", total=Decimal("89.50"),
              items=[{"sku": "SHOE-11", "name": "Running shoes", "qty": 1}],
              placed_at=d(6), delivered_at=d(3), carrier="Evri", tracking_number="EV777"),
        Order(id="ORD-2002", customer_id="cust_002", status="placed", total=Decimal("12.00"),
              items=[{"sku": "SOCK-05", "name": "Socks (3 pack)", "qty": 1}],
              placed_at=d(0), delivered_at=None, carrier=None, tracking_number=None),
    ]
