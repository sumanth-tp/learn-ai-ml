...
InstructGPT changes the training objective from merely predicting plausible text to producing responses that human evaluators prefer for a given instruction.
